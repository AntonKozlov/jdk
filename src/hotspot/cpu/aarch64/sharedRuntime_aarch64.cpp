...
static int private_c_calling_convention(const BasicType *sig_bt,
                                         VMRegPair *regs,
                                         VMRegPair *regs2,
                                         int total_args_passed) {
...
int SharedRuntime::c_calling_convention(const BasicType *sig_bt,
                                         ...
                                         int total_args_passed)
{
  int result = private_c_calling_convention(sig_bt, regs, regs2, total_args_passed);
...
nmethod* SharedRuntime::generate_native_wrapper(MacroAssembler* masm,
  ...
  // they require.
  int out_arg_slots;
  out_arg_slots = private_c_calling_convention(out_sig_bt, out_regs, NULL, total_c_args);
